...
export const generateMockData = (): DashboardData => {
  return {
    ...
    lastMonthRevenue: {
      total: 245000000,
      byChannel: [
        { channel: '토탈 마케팅', value: 70000000 },
        { channel: '퍼포먼스', value: 60000000 },
        { channel: '배달관리', value: 35000000 },
        { channel: '브랜드블로그', value: 20000000 },
        { channel: '댓글', value: 25000000 },
        { channel: '미디어', value: 20000000 },
        { channel: '당근', value: 15000000 },
      ],
    },
    currentMonthRevenue: {
      total: 268000000,
      byChannel: [
        { channel: '토탈 마케팅', value: 75000000 },
        { channel: '퍼포먼스', value: 65000000 },
        { channel: '배달관리', value: 38000000 },
        { channel: '브랜드블로그', value: 22000000 },
        { channel: '댓글', value: 28000000 },
        { channel: '미디어', value: 23000000 },
        { channel: '당근', value: 17000000 },
      ],
    },
    totalClients: {
      total: 210,
